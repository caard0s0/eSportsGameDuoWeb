...
export function CreateAdModal() {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2a2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[545px] shadow-lg shadow-black/25">
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input name="name" id="name" placeholder="What are you called in the game?" />
          ...
          <div className="grid grid-cols-2 gap-2 items-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <label htmlFor="hourStart">What time of day do you play?</label>
